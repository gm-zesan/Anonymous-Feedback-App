        ...
        if (empty($errors)) {
            ...
            if (file_exists($file)) {
                ...
                foreach ($users as $user) {
                    list($stored_name, $stored_email, $stored_password_hash) = explode(',', $user);
                ...
                $errors['auth_error'] = 'No users found. Please register first.';
            }
        }
    }
?>
    ...
    <div class="relative flex min-h-screen flex-col justify-center overflow-hidden bg-gray-50 py-6 sm:py-12">
        ...
        <div class="relative bg-white px-6 pt-10 pb-8 shadow-xl ring-1 ring-gray-900/5 sm:mx-auto sm:max-w-lg sm:rounded-lg sm:px-10">
            ...
            <?php
                ...
                if ($message) : ?>
                    <div class="mt-2 bg-teal-100 border border-teal-200 text-sm text-center text-teal-800 rounded-lg p-4" role="alert">
                        <span class="font-bold"><?= $message; ?></span>
                    </div>
            <?php endif; ?>

            <?php if (isset($errors['auth_error'])) : ?>
                <div class="mt-2 bg-red-100 border border-red-200 text-sm text-center text-red-800 rounded-lg p-4" role="alert">
